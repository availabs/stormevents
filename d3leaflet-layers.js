(function() {
  ...
  L.GeoJSON.d3 = L.GeoJSON.extend({
    ...
    updateData: function() {
      ...
      if(typeof layer_options.attr_functions != 'undefined'){
        Object.keys(layer_options.attr_functions).forEach(function(key){
          
          feature.attr(key,layer_options.attr_functions[key]);
      ...
      if(typeof layer_options.event_functions != 'undefined'){
        Object.keys(layer_options.event_functions).forEach(function(key){
          
          feature.on(key,layer_options.event_functions[key]);
